...
# school IP addresses
# GW: ssh pi@172.20.10.3
# pi10: ssh pi@172.20.10.12
# pi3: ssh pi@172.20.10.6




# Use the same parameters to switch modes for both radios independantly,
# Then transition to transmitting dummy data and switching.
